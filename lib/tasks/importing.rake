...
namespace :import do 
  ...
  task :parallel_import_archive,[:working_directory,:number_of_records, :number_of_entries, :format, :number_of_times,:workers,:force,:descrete_measurement,:no_record, :no_save] => :environment do |t,args|
